...
public class ContentManager {
	...
	public static ContentManager getInstance() {
		if (_instance == null)
			_instance = new ContentManager(KinectApp.instance);
	...
	public void loadAssets(KinectApp parent,
	...
	private void loadShaders(KinectApp parent, ArrayList<AssetEntry> entries) {
		PShader shader;
		String path;
	...
	public void loadGalleryEntries(PApplet instance,
		...
		for (ImageEntry entry : readImageEntries) {
			...
			addGalleryImage(entry, instance.loadImage(Controller.DATA_PATH
					+ entry.filePath));
		}
	}
